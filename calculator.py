...
def equals():
    ...
    try:
        total = str(eval(equation_text))  # eval parses the expression we pass in
        equation_label.set(total)
        equation_text = total

    except ZeroDivisionError:
        equation_label.set(("arthmatic error"))
        equation_text = ""
...
clear= Button(window, text ='clear', height = 4, width = 14, font=35, command = clear)
clear.pack()
